...
import { Calendar as CalendarIcon, Target, DollarSign, Plus, Minus, Briefcase, ListChecks, Code2, Palette, Megaphone, FlaskConical, Layers, FileText, Users } from "lucide-react";
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 bg-slate-50 border border-slate-200">
                                ...
                                <ul className="text-[10px] text-slate-500 space-y-1">
                                    ...
                                    <li>5. Winner receives funds directly</li>
                                </ul>
                            </div>
                        </div>
                    </div>
