...
export function ReputationSkeleton() {
    return (
        <div className="space-y-8 animate-pulse">
            <Card className="rounded-[2rem] border border-white/60 bg-white/40 backdrop-blur-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                    <Card key={i} className="rounded-[1.5rem] border border-white/60 bg-white/40 backdrop-blur-xl p-6">
