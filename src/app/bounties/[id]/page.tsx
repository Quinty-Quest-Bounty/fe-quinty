                            ...
                            {bounty.hasOprec && bounty.status === 0 && !isCreator && (
                                <div className="mb-4">
                                    {userOprecApplication ? (
                                        ...
                                        <Card className={`rounded-[1.5rem] shadow-md transition-all duration-300 ${userOprecApplication.approved
                                    ...
                                    <div className="space-y-2">
                                        {bounty.submissions.map((sub, index) => {
                                            ...
                                            return (
                                                <Card
                                                    key={index}
                                                    className={`rounded-[1.25rem] transition-all duration-300 ${isWinner
