          ...
          <Card className="rounded-[2rem] border border-white/60 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.01]">
            ...
            <CardContent className="pt-3">
              ...
              {!isExpired && !airdrop.resolved && !airdrop.cancelled && airdrop.qualifiersCount < airdrop.maxQualifiers && (
                <div className="mb-4">
                  {userEntry ? (
                    <Card className="rounded-[1.5rem] bg-blue-50 border-blue-200 shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {entries.map((entry, index) => (
                      <Card key={index} className="rounded-[1.25rem] transition-all duration-300 hover:shadow-md">
