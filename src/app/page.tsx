...
const bountyStackFeatures = [
  { text: "ETH Escrow", color: "bg-pink-200" },
  { text: "Blind Submissions", color: "bg-blue-200" },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <main className="px-4 pb-16 pt-8 sm:px-6 sm:pb-24 sm:pt-12 lg:px-0 lg:pb-32">
        <div className="mx-auto w-full max-w-6xl">
          <section className="mx-auto mb-8 max-w-7xl px-4 sm:mb-10 sm:px-6 md:mb-20 xl:px-0">
            <div className="relative flex flex-col items-center rounded-2xl sm:rounded-3xl overflow-hidden shadow-md hover:shadow-xl min-h-[70vh] sm:min-h-[75vh] md:min-h-[80vh] justify-center">
              ...
              <div className="relative z-20 mx-auto w-full max-w-7xl py-6 px-4 sm:py-8 sm:px-6 md:py-12 xl:py-16">
                <div className="text-center space-y-4 sm:space-y-6 md:space-y-8">
                  ...
                  <Button
                    ...
                    className="animate-slide-up animation-delay-300 hover:scale-105 text-sm sm:text-base"
                  >
                    Explore bounties
                  </Button>
                </div>
          ...
          <section className="mt-12 sm:mt-16 md:mt-24">
            <div className="text-center mb-8 sm:mb-10 md:mb-12" data-animation="fade-scale">
              <Badge
                variant="secondary"
                className="rounded-full px-3 py-0.5 sm:px-4 sm:py-1 text-[10px] sm:text-xs uppercase tracking-[0.2em] border-gray-300 bg-gray-50 text-gray-600 hover:bg-gray-100"
              >
                Platform Preview
              </Badge>
              ...
              <Safari url="quinty.xyz" className="w-full">
                <div className="relative h-full w-full bg-gradient-to-br from-gray-50 to-gray-100 p-8 sm:p-12 md:p-16">
                  <div className="relative flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 h-full">
                    <div className="relative flex h-24 w-24 sm:h-32 sm:w-32 md:h-40 md:w-40 items-center justify-center rounded-full bg-white backdrop-blur-sm shadow-2xl border border-gray-200 hover:shadow-3xl hover:scale-110">
                      <div className="relative h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24">
                        <Image
                          src="/images/quinty-logo.png"
                          alt="Quinty Logo"
          ...
          <section className="mt-12 sm:mt-16 md:mt-24 space-y-12 sm:space-y-16 md:space-y-20">
            {allFeatures.map((feature, index) => (
              ...
              >
                ...
                >
                  <div className="relative w-full aspect-[16/10] rounded-xl sm:rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 overflow-hidden hover:border-[#0EA885] hover:shadow-xl">
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 sm:gap-3 md:gap-4 p-4 sm:p-6 md:p-8">
                      <feature.icon className="h-10 w-10 sm:h-12 sm:w-12 md:h-16 md:w-16 text-gray-400 group-hover:text-[#0EA885] group-hover:scale-110" />
                      <div className="text-center space-y-1 sm:space-y-2">
                ...
                >
                  <div className="flex items-center gap-4">
                    <Badge
                      variant="outline"
                      className="rounded-full border-gray-300 bg-gray-50 px-3 py-1 sm:px-4 sm:py-1.5 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-gray-600 hover:bg-gray-100"
                    >
                      {feature.status}
                    </Badge>
                  </div>
                  <h2 className="text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-foreground hover:text-[#0EA885]">
                    {feature.title}
                  </h2>
          ...
          <section className="mt-12 sm:mt-16 md:mt-24">
            ...
            <div
              className="relative rounded-3xl border border-gray-200 bg-white/90 p-4 sm:p-6 md:p-8 hover:shadow-xl overflow-hidden h-[400px] sm:h-[500px] md:h-[600px]"
              ...
              >
                {bountyStackFeatures.map((feature, index) => (
                  <MatterBody
                    ...
                    isDraggable={false}
                  >
                    <div className={`rounded-xl sm:rounded-2xl border-2 border-gray-300 ${feature.color} px-3 py-2 sm:px-4 sm:py-3 md:px-6 md:py-4 text-center text-sm sm:text-base md:text-lg font-bold shadow-lg select-none`}>
                      {feature.text}
                    </div>
                  </MatterBody>
                ))}
                  ...
                  <div className="grid gap-2 sm:gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    {contractReferences.map((reference) => (
                      <div
                        ...
                        className="rounded-lg sm:rounded-xl border border-gray-200 bg-background/50 p-2.5 sm:p-3 hover:border-gray-300"
                      >
          ...
          <section
            className="mt-12 sm:mt-16 md:mt-24 text-center rounded-2xl sm:rounded-3xl border border-gray-200 bg-white/90 px-4 py-8 sm:px-6 sm:py-12 md:px-8 md:py-16 hover:shadow-xl"
            data-animation="fade-scale"
          >
            <h2 className="text-xl font-semibold sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-4 sm:mb-6 text-foreground hover:text-[#0EA885] px-2">
            ...
            <div className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
              <p className="mb-3 sm:mb-4">
                ...
                <LinkPreview
                  ...
                  className="font-bold text-[#0EA885] hover:text-[#0EA885]/80 hover:underline"
                >
                  Quinty
                </LinkPreview>{" "}
            ...
            <div className="mt-6 sm:mt-8 flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base text-gray-500 hover:text-[#0EA885]">
              <svg
