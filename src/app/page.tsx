...
export default function Home() {
 ...
 <main className="relative px-4 pt-8">
  ...
  <div className="relative flex flex-col items-center rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-lg min-h-[70vh] sm:min-h-[75vh] md:min-h-[80vh] justify-center backdrop-blur-xl bg-white/70 border border-white/60 transition-all duration-300 hover:bg-white/80">
   ...
   <Button
    ...
    className="animate-slide-up animation-delay-300 transition-all duration-300 text-sm sm:text-base hover:brightness-90"
   >
    Explore bounties
   </Button>
   </div>
  ...
  >
   <Badge
   variant="secondary"
   className="rounded-full px-3 py-0.5 sm:px-4 sm:py-1 text-[10px] sm:text-xs uppercase tracking-[0.2em] border-gray-300 bg-gray-50 text-gray-600 hover:bg-gray-100 transition-all duration-300"
   >
   Platform Preview
   </Badge>
  ...
  {allFeatures.map((feature, index) => (
   ...
   >
   <div className="relative w-full aspect-[16/10] rounded-[1.5rem] sm:rounded-[2rem] border-2 border-dashed border-gray-300 bg-gray-50 overflow-hidden hover:border-[#0EA885] hover:bg-gray-100 transition-all duration-300">
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 sm:gap-3 md:gap-4 p-4 sm:p-6 md:p-8">
    <feature.icon className="h-10 w-10 sm:h-12 sm:w-12 md:h-16 md:w-16 text-gray-400 group-hover:text-[#0EA885] transition-all duration-300" />
   ...
   <div className="flex items-center gap-4">
    <Badge
    variant="outline"
    className="rounded-full border-gray-300 bg-gray-50 px-3 py-1 sm:px-4 sm:py-1.5 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-gray-600 hover:bg-gray-100 transition-all duration-300"
    >
    {feature.status}
    </Badge>
   </div>
  ...
  <Card className="border border-white/60 bg-white/70 backdrop-blur-xl shadow-lg transition-all duration-300 hover:bg-white/80">
