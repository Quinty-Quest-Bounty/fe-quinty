      ...
      <main className="relative z-10">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="container px-4 mx-auto text-center relative z-10 py-20 lg:py-28">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5  bg-white/60 border border-emerald-100/50 backdrop-blur-md mb-8 shadow-sm hover:shadow-md transition-all cursor-pointer group dark:bg-black/40 dark:border-gray-800"
              onClick={() => setIsAnnouncementModalOpen(true)}
            >
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full  bg-[#0EA885] opacity-75"></span>
                <span className="relative inline-flex  h-2.5 w-2.5 bg-[#0EA885]"></span>
              </span>
            ...
            >
              <Button
                size="lg"
                className="h-14 px-10 text-base md:text-lg bg-[#0EA885] hover:bg-[#0b8a6c] text-white  shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group relative overflow-hidden"
              ...
              <Button
                variant="outline"
                size="lg"
                className="h-14 px-10 text-base md:text-lg  border-gray-200 bg-white/50 backdrop-blur-sm hover:bg-white hover:border-gray-300 transition-all dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10 dark:text-white"
          ...
          <motion.div style={{ y }} className="absolute top-40 left-[5%] lg:left-[15%] hidden lg:block pointer-events-none">
            <div className="bg-white/70 backdrop-blur-2xl p-5  shadow-[0_8px_32px_rgba(0,0,0,0.06)] border border-gray-200/60 rotate-[-6deg] hover:rotate-0 transition-transform duration-500 dark:bg-black/40 dark:border-white/10 dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10  bg-green-50 flex items-center justify-center dark:bg-green-500/10 border border-green-100/50 dark:border-green-500/20">
          ...
          <motion.div style={{ y: useTransform(y, val => val * -0.8) }} className="absolute bottom-40 right-[5%] lg:right-[12%] hidden lg:block pointer-events-none">
            <div className="bg-white/70 backdrop-blur-2xl p-5  shadow-[0_8px_32px_rgba(0,0,0,0.06)] border border-gray-200/60 rotate-[6deg] hover:rotate-0 transition-transform duration-500 dark:bg-black/40 dark:border-white/10 dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10  bg-purple-50 flex items-center justify-center dark:bg-purple-500/10 border border-purple-100/50 dark:border-purple-500/20">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center py-24 bg-gradient-to-b from-gray-50/50 to-white relative overflow-hidden perspective-1000 dark:from-gray-950/50 dark:to-black">
          ...
          <div className="container px-4 mx-auto relative z-20">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5  border border-emerald-100 bg-emerald-50/50 backdrop-blur-md mb-8 shadow-sm dark:border-emerald-500/20 dark:bg-emerald-500/10 dark:text-emerald-300">
                <div className="w-2 h-2  bg-[#0EA885] animate-pulse" />
            ...
            >
              ...
              <div className="relative  border border-gray-200 bg-white shadow-2xl overflow-hidden ring-1 ring-black/5 group dark:border-white/10 dark:bg-black/40 dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:ring-white/5">
                ...
                <div className="flex items-center gap-4 px-4 py-3 border-b border-gray-100 bg-gray-50/80 backdrop-blur-sm dark:border-white/5 dark:bg-black/40">
                  <div className="flex gap-1.5">
                    <div className="w-2.5 h-2.5  bg-[#FF5F57] border border-black/5 dark:border-white/10" />
                    <div className="w-2.5 h-2.5  bg-[#FEBC2E] border border-black/5 dark:border-white/10" />
                    <div className="w-2.5 h-2.5  bg-[#28C840] border border-black/5 dark:border-white/10" />
                  </div>
                  <div className="flex-1 flex justify-center">
                    <div className="flex items-center gap-1.5 px-3 py-1  bg-white border border-gray-200 shadow-sm transition-shadow group-hover:shadow-md dark:bg-black/50 dark:border-gray-700">
              ...
              <div className="absolute -inset-4 -z-10 bg-gradient-to-b from-emerald-500/20 to-transparent blur-2xl opacity-40  dark:from-emerald-500/10" />
            </motion.div>
          </div>
        </section>
        ...
        <section id="features" className="py-24 bg-white dark:bg-black relative overflow-hidden">
          ...
          <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
            ...
            <motion.div
              className="absolute top-20 left-10 w-72 h-72 bg-blue-500/10  blur-3xl"
              animate={{
                x: [0, 50, 0],
                y: [0, 30, 0],
                scale: [1, 1.1, 1]
            ...
            />
            <motion.div
              className="absolute bottom-20 right-10 w-96 h-96 bg-purple-500/10  blur-3xl"
              animate={{
                x: [0, -50, 0],
                y: [0, -30, 0],
                scale: [1, 1.2, 1]
          ...
          <div className="container px-4 mx-auto relative z-10">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-5 py-2  border border-blue-200/60 bg-gradient-to-r from-blue-50 to-purple-50 text-blue-600 mb-8 shadow-lg shadow-blue-500/10 dark:border-blue-500/30 dark:from-blue-500/10 dark:to-purple-500/10 dark:text-blue-400 dark:shadow-blue-500/20"
              >
                <span className="relative flex h-2.5 w-2.5">
                  <span className="animate-ping absolute inline-flex h-full w-full  bg-blue-500 opacity-75"></span>
                  <span className="relative inline-flex  h-2.5 w-2.5 bg-blue-600 dark:bg-blue-400 shadow-lg shadow-blue-500/50"></span>
                </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/20 to-purple-500/20  blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
                <div className="flex flex-col h-full justify-between relative z-10">
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <motion.div
                      ...
                      className="h-14 w-14  bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/40 dark:shadow-blue-500/60 border-2 border-white/20"
                    >
                      <Target className="h-7 w-7" />
                    </motion.div>
                  </div>
                  {/* Mini UI */}
                  <div className="bg-white/80 backdrop-blur-sm  border border-blue-100 p-4 shadow-lg flex items-center gap-3 mt-4 group-hover:shadow-xl group-hover:border-blue-300 transition-all duration-300 dark:bg-black/60 dark:border-blue-500/30 dark:group-hover:border-blue-500/60">
                    <motion.div
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      className="h-10 w-10  bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/50"
                    >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="h-2 w-full bg-slate-100  overflow-hidden dark:bg-gray-800 shadow-inner">
                        <motion.div
                          initial={{ width: 0 }}
                          whileInView={{ width: "100%" }}
                          transition={{ duration: 1.5, delay: 0.5 }}
                          className="h-full bg-gradient-to-r from-blue-500 to-blue-600  shadow-[0_0_12px_rgba(59,130,246,0.7)]"
                        />
                      </div>
                    </div>
              ...
              >
                ...
                {/* Glow effect on hover */}
                <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20  blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
                ...
                <div className="flex flex-col h-full justify-between relative z-10">
                  <div className="mb-4">
                    <motion.div
                      whileHover={{ rotate: 360, scale: 1.1 }}
                      transition={{ duration: 0.6 }}
                      className="h-14 w-14  bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white mb-4 shadow-lg shadow-purple-500/40 dark:shadow-purple-500/60 border-2 border-white/20"
                    >
                  ...
                  {/* Mini UI */}
                  <div className="bg-white/80 backdrop-blur-sm  border border-purple-100 p-3 shadow-lg text-center group-hover:shadow-xl group-hover:border-purple-300 transition-all duration-300 dark:bg-black/60 dark:border-purple-500/30 dark:group-hover:border-purple-500/60">
                    <motion.span
                      whileHover={{ scale: 1.05 }}
                      className="inline-flex items-center gap-1.5 px-3 py-2  bg-gradient-to-r from-purple-500 to-pink-500 text-[11px] font-bold text-white shadow-lg shadow-purple-500/50 cursor-pointer"
                    >
              ...
              <motion.div
                ...
                whileHover={{ y: -5, scale: 1.02 }}
                className="col-span-1 md:col-span-3 group relative overflow-hidden  border border-blue-200/50 bg-gradient-to-br from-white to-blue-50/30 p-8 hover:border-blue-400/60 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 dark:border-blue-500/20 dark:from-white/5 dark:to-blue-500/5 dark:hover:border-blue-500/60 dark:hover:shadow-blue-500/30 backdrop-blur-sm"
              >
                {/* Animated gradient overlay */}
                ...
                {/* Glow effect on hover */}
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/20 to-indigo-500/20  blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
                ...
                <div className="flex flex-col h-full justify-between relative z-10">
                  <div className="mb-4">
                    <motion.div
                      ...
                      className="h-14 w-14  bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white mb-4 shadow-lg shadow-blue-500/40 dark:shadow-blue-500/60 border-2 border-white/20"
                    >
                  ...
                  {/* Mini UI */}
                  <div className="bg-white/80 backdrop-blur-sm  border border-blue-100 p-4 shadow-lg text-center group-hover:shadow-xl group-hover:border-blue-300 transition-all duration-300 dark:bg-black/60 dark:border-blue-500/30 dark:group-hover:border-blue-500/60">
                    <motion.span
                      animate={{ scale: [1, 1.05, 1] }}
                      transition={{ duration: 2, repeat: Infinity }}
                      className="inline-flex items-center gap-1.5 px-4 py-2  bg-gradient-to-r from-blue-500 to-indigo-500 text-xs font-bold text-white shadow-lg shadow-blue-500/50 cursor-pointer"
                    >
              ...
              >
                ...
                <div className="flex-shrink-0 relative z-10">
                  <motion.div
                    ...
                    className="flex items-center gap-3 bg-white/90 backdrop-blur-sm pl-4 pr-6 py-4  border border-blue-200 shadow-lg hover:shadow-xl hover:border-blue-400 transition-all duration-300 dark:bg-black/60 dark:border-blue-500/30 dark:hover:border-blue-500/60 dark:shadow-blue-500/10"
                  >
                    <div className="relative">
                      <motion.div
                        whileHover={{ scale: 1.1 }}
                        className="w-12 h-12  bg-gradient-to-br from-slate-100 to-slate-200 overflow-hidden shadow-md dark:from-gray-800 dark:to-gray-700"
                      >
                      ...
                      <motion.div
                        ...
                        transition={{ duration: 2, repeat: Infinity }}
                        className="absolute -bottom-1 -right-1 bg-gradient-to-br from-green-400 to-green-600 text-white p-1  border-2 border-white shadow-lg shadow-green-500/50 dark:border-black"
                      >
                    ...
                    <Button size="sm" variant="ghost" className="text-blue-600 hover:text-white hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 text-xs h-auto py-2 px-4 font-bold  transition-all duration-300 dark:text-blue-400 dark:hover:text-white shadow-sm hover:shadow-md">
                      Connect
                    </Button>
                  </motion.div>
                </div>
        ...
        <section className="py-16 border-t border-gray-100 bg-gradient-to-b from-gray-50/30 to-white relative dark:border-white/5 dark:from-gray-950/30 dark:to-black overflow-hidden">
          ...
          <div className="container px-4 mx-auto max-w-6xl relative z-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <div className="flex items-center gap-3">
                <div className="h-2 w-2  bg-[#0EA885] animate-pulse" />
              ...
              <div className="flex items-center gap-2 px-3 py-1.5  bg-slate-50 border border-slate-100 dark:bg-white/5 dark:border-white/10">
              ...
              {contractReferences.map((contract, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group flex items-center justify-between p-3 bg-white  border border-slate-200 hover:border-[#0EA885]/30 hover:shadow-lg hover:shadow-[#0EA885]/5 transition-all duration-300 cursor-default dark:bg-white/5 dark:border-white/10 dark:hover:bg-white/10"
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="flex-shrink-0 h-9 w-9  bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 group-hover:text-[#0EA885] group-hover:bg-[#0EA885]/5 transition-colors dark:bg-black/40 dark:border-white/5">
